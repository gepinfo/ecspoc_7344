...
{ path : 'staffcreate', loadChildren: () => import('./staffcreate/staffcreate.module').then(m => m.StaffcreateModule), canActivate: [AuthGuard] } , 
{ path : 'staffget', loadChildren: () => import('./staffget/staffget.module').then(m => m.StaffgetModule), canActivate: [AuthGuard] } , 
];
